...
<li>Всегда есть <i>малая</i> вероятность появления ошибки "A.I. Disabled".</li>
...
<ul>
<li>Steam в данный момент ограничивает ваши запросы к своим серверам из-за некоего механизма защиты.</li>
